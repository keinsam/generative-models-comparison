...
# from models.base_models import DDPM, Diffusion, GAN_Generator, GAN_Critic, initialize_weights
...
# def generate_and_visualize_samples_ddpm(model, diffusion, device, num_samples=8):
#     model.eval()
#     with torch.no_grad():
#         # Generate samples
...
# def generate_and_visualize_samples_gan(generator, device, num_samples=8):
#     generator.eval()
#     with torch.no_grad():
...
#     #            writer=ddpm_writer)
#     # generate_and_visualize_samples_ddpm(ddpm, diffusion, DEVICE)
...
#         writer=gan_writer
#     )
#     # generate_and_visualize_samples_gan(generator, DEVICE)