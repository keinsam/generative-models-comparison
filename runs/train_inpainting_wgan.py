...
from datasets.inpainting_datasets import InpaintingCIFAR10  # Use inpainting dataset
from models.inpainting_models import InpaintingGenerator, InpaintingCritic  # Use inpainting models
